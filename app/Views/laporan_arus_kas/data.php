                            ...
                            <div class="table-responsive">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2 font-weight-bold">
                                        ...
                                        if (@$hak == 'Petugas TU') {
                                        ?>
                                            <a target="blank" href="<?= base_url('cetak_laporan_arus_kas/' . $bulan) ?>" class="btn btn-primary btn-xs float-left mb-4"><i class="fa fa-print"></i>Cetak</a>
                                        <?php
                                        }
                                        ?>
...
<script type="text/javascript">
    $('#bulan').on('change', function() {
        window.location.href = "<?= base_url() ?>/laporan_arus_kas/index/" + $(this).val();
    });
</script> <!-- Footer -->